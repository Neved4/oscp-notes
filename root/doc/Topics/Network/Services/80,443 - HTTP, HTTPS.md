...
- [ ] Look into the dir tree: `wfuzz`, `fuff`, `gobuster`, `dir`, `dirsearch`, `feroxbuster`
  ```bash
  list='/usr/share/wordlists/seclists/Discovery/Web-Content/directory-list-2.3-medium.txt'

  gobuster dir -u $ip -w $directoryListMedium -x php,html,zip,txt,conf,bak,tar,sh -b 403,404
  ```
